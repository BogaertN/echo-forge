...
from agents.decider_agent import SynthesizerAgent as DeciderAgent
from agents.auditor import AuditorAgent
from agents.journal_assistant import JournalAssistantAgent as JournalingAssistant
from agents.specialist_agents import SpecialistManager as SpecialistAgent
    ...
    def __init__(self, db, journal_manager, resonance_manager, tool_manager):
        ...
        if "models" not in self.config:
            self.config["models"] = {
                ...
                "specialist": "llama3:8b"
            }
        
        # Add default agent_settings if missing
        if "agent_settings" not in self.config:
